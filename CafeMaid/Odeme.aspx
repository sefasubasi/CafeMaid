...
<label class="radio"> <input type="radio" name="card" value="payment"> <span><img width="30" src="https://img.icons8.com/officel/48/000000/paypal.png"/></span> </label>
                    <div><label class="credit-card-label">Name on card</label>
                        
                        <input id="cName" type="text" class="form-control credit-inputs" placeholder="Name"></div>

                    <div><label class="credit-card-label">Card number</label>
                        
                        <input id="cNo" type="text" class="form-control credit-inputs" placeholder="0000 0000 0000 0000"></div>

                    <div class="row">
                        <div class="col-md-6"><label class="credit-card-label">Date</label>
                            
                            <input id="cSKT" type="text" class="form-control credit-inputs" placeholder="12/24"></div>

                        <div class="col-md-6"><label class="credit-card-label">CVV</label>
                            
                            <input id="cCvc" type="text" class="form-control credit-inputs" placeholder="342"></div>
        ...
        <%--"<input type='text' id='quantity" + data.Id + "' name='quantity" + data.Id + "' class='form-control input-number' value='" + data.UrunAdet + "' min='1' max='100' style='width: 40px; text-align: center; font-size: 10px; margin-left: 2px; margin-right: 2px;'>" +--%>
                    ...
                    <hr />
                    <button id="OdemeButton"  class="btn btn-primary btn-block d-flex justify-content-between mt-3" type="button"><input style="text-align:center;" type="text" id="TotalTutar1" name="TotalTuTar" value="0"/>
